...
async function initHomePage() {
  ...
  const heroMobileLines = heroDisplayLines.flatMap((line, index) => {
    const phraseBoundary = index === 0 ? line.indexOf('å®Ÿå‹™çµŒé¨“') : -1;
